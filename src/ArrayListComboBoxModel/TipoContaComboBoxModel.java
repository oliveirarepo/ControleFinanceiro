 ...
 * @author Thaigo
 */
public class TipoContaComboBoxModel extends AbstractListModel implements MutableComboBoxModel {

    private Object selectedItem;
    // Define List variable
    private final List<TipoConta> list;

    public TipoContaComboBoxModel(List<TipoConta> list) {
    ...
    public Object getElementAt(int i) {
        ...
        //return list.get(i);
        TipoConta tipoConta = list.get(i);
