 ...
 * @author Thaigo
 */
public class ContaComboBoxModel extends AbstractListModel implements MutableComboBoxModel {

    private Object selectedItem;
    // Define List variable
    private final List<Conta> list;

    public ContaComboBoxModel(List list) {
    ...
    public Conta getContaSelecionada(int rowIndex) {
