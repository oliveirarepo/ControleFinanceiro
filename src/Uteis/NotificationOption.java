 ...
 * @author Thiago
 */
public class NotificationOption extends JDialog {
    ...
    public static void main(final String[] args) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                final NotificationOption f = new NotificationOption();
                ...
                final JLabel l = new JLabel("Registro excluido com sucesso");
                l.setOpaque(false);
                ...
                c.add(b, constraints);
                final JButton jBtnDesfazer = new JButton(new AbstractAction("Desfazer") {

                    @Override
                    public void actionPerformed(final ActionEvent e) {
                        JOptionPane.showMessageDialog(null, "desfazer");
                    }
                });

                jBtnDesfazer.setOpaque(false);
                jBtnDesfazer.setMargin(new Insets(1, 4, 1, 4));
                jBtnDesfazer.setFocusable(false);
